...
<head>
    ...
    <title>BOOKA - Admin Management</title>
...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col fixed h-full z-20 transition-colors duration-300">
        ...
        <nav class="flex-1 px-4 space-y-2">
            ...
            <a class="sidebar-item-active flex items-center gap-3 px-4 py-3 rounded-xl font-semibold shadow-md shadow-rose-200 dark:shadow-none transition-all" href="admin.php">
    ...
    <main class="flex-1 ml-64 p-8 bg-slate-50 dark:bg-slate-950 min-h-screen transition-colors duration-300">
        ...
        <header class="flex justify-between items-center mb-8">
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Admin Management</h1>
        ...
        <section class="mb-8">
            <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm p-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-xl font-bold text-slate-800 dark:text-white">Add New Admin</h2>
                </div>
                <form action="" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-slate-600 dark:text-slate-300">NIK</label>
                        <input type="text" name="nik" placeholder="Enter NIK" class="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-primary focus:border-primary transition-colors">
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" name="email" placeholder="email@example.com" class="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-primary focus:border-primary transition-colors">
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea name="alamat" rows="2" placeholder="Enter full address" class="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-primary focus:border-primary transition-colors resize-none"></textarea>
                    </div>
                    <div class="md:col-span-2 flex justify-end gap-3 mt-2">
                        ...
                        <button type="submit" class="px-8 py-2.5 rounded-xl font-bold text-white bg-primary hover:bg-rose-600 shadow-lg shadow-red-500/20 transition-all flex items-center gap-2">
                            <span class="material-symbols-outlined">save</span> Save Admin
                        </button>
                    </div>
                </form>
            </div>
        ...
        <section>
            <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                <div class="p-8 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row justify-between md:items-center gap-4">
                    <div>
                        <h2 class="text-xl font-bold text-slate-800 dark:text-white">Admin List</h2>
                        <p class="text-slate-500 text-sm mt-1">Manage current administrator accounts</p>
                    </div>
                    <div class="flex gap-2">
                        <input type="text" placeholder="Search admin..." class="px-4 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-sm focus:ring-primary">
                    </div>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            ...
                            <tr class="group hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                <td class="p-6 font-medium text-slate-700 dark:text-slate-300">32011234567890</td>
                                ...
                                <td class="p-6 text-slate-600 dark:text-slate-400">admin@booka.com</td>
                                <td class="p-6 text-slate-600 dark:text-slate-400 max-w-xs truncate">Jl. Mawar No. 12, Jakarta Selatan</td>
                            ...
                            <!-- Row 2 -->
                            <tr class="group hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                <td class="p-6 font-medium text-slate-700 dark:text-slate-300">32019876543210</td>
                                <td class="p-6 text-slate-600 dark:text-slate-400">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-bold text-xs">NF</div>
                                        fadilla_adm
                                    </div>
                                </td>
                                <td class="p-6 text-slate-600 dark:text-slate-400">fadilla@booka.com</td>
                                <td class="p-6 text-slate-600 dark:text-slate-400 max-w-xs truncate">Perumahan Indah Blok C, Bandung</td>
                                <td class="p-6 text-center">
                                    <div class="flex items-center justify-center gap-2">
                ...
                <div class="p-6 border-t border-slate-100 dark:border-slate-800 flex justify-center">
                    <button class="text-sm font-bold text-primary hover:text-rose-700 transition-colors">View All Admins</button>
                </div>
            </div>
        </section>
